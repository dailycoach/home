(function(root,factory){
  ...
  function getWeek(journey,week){const base=journey&&Array.isArray(journey.weeks)?journey:normalize(journey);if(!base)return null;return base.weeks[Math.min(MAX_WEEKS,Math.max(1,Number(week)||base.currentWeek))-1];}
