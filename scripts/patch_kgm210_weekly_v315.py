...
def main() -> None:
    ...
    if text != original:
        ...
        print("patched tests/kgm210/index.html for seven-week journey v3.15")
    elif bootstrap_active:
        print("seven-week journey v3.15 loads through the profile-engine bootstrap")
    else:
        print("seven-week journey v3.15 tags already present; no changes")
