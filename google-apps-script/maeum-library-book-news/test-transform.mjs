...
const editorial = [
  ...
  ['N-1', '발행 예약', '새로 나온 책', '승인된 제목', '승인된 사실 요약', '독자에게 의미 있는 이유', '공식 출처', 'https://example.com/news/1', '2026-08-01', 'https://maeum-library-talk.dailycoaching.chatgpt.site/images/editorial/news-books.webp', '마음서재 자체 제작', '확인 완료', '마음서재 편집부', '승인', '2026-08-02'],
...
assert.ok(payload.items[0].imageUrl.includes('/images/editorial/'));
